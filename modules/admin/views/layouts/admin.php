...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?= Yii::getAlias('@web') ?>/admin" class="logo">
      ...
      <span class="logo-mini">NT<?php /* Html::img(Yii::getAlias('@web') . '/pks/img/logo1.png', ['style'=>'width:50px'])*/?></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg">WEBSITE NT<?php /* Html::img(Yii::getAlias('@web') . '/pks/img/logo1.png', ['style'=>'width:50px'])*/?></span>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; <?= date('Y') ?> - Website Nguyễn Trình</a>.</strong> All rights
    reserved.
  </footer>

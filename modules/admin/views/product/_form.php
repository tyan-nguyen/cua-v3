...
<div class="row">
	...
	<div class="col-md-9">
     ...
     <?= $form->field($model, 'is_product')->hiddenInput(['value' => 1])->label(false); ?>
    ...
    <?= $form->field($model, 'summary')->textarea(['rows' => 3, 'id'=>'txtSummary']) ?>
...
//editor for content
tinymce.init({
	selector: "#txtContent,#txtSummary",
	branding: false,
	statusbar: false,

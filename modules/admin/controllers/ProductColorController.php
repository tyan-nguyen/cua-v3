...
/**
 * ProductColorController implements the CRUD actions for ProductColors model.
 */
class ProductColorController extends Controller
{
     ...
     * @return mixed
     */
    public function actionCreate($idProduct=NULL)
    {
        $request = Yii::$app->request;
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Create new version of product",
                ...
                return [
                    ...
                    'title'=> "Create new ProductColors",
                    'content'=>'<span class="text-success">Create ProductColors success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    public function actionUpdate($id)
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Update Version of produt",
    ...
    /**
     * Delete an existing ProductColors model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing ProductColors model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed

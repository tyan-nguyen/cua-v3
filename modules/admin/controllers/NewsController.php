                ...
                if($model->save()){
                    if($_POST['btnsubmit'] && $_POST['btnsubmit']=='thoat'){
                        if($model->is_static == true){
                            return $this->redirect([Yii::getAlias('@web/admin/news'),'page'=>true, 'showUpdateSuccess'=>true]);
                        } else {
                            return $this->redirect([Yii::getAlias('@web/admin/news'), 'showUpdateSuccess'=>true]);
                        }
                    } else {

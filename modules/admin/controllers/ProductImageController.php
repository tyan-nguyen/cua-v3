...
/**
 * ProductImageController implements the CRUD actions for ProductImages model.
 */
class ProductImageController extends Controller
{
    ...
    public function actionCreate($idProduct=NULL)
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Create new Image of Product",
                ...
                return [
                    ...
                    'title'=> "Create new ProductImages",
                    'content'=>'<span class="text-success">Create ProductImages success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    /**
     * Delete an existing ProductImages model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing ProductImages model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed

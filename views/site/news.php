    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8 news-content">
                ...
                <!-- <p class="lead mb-4 text-center"><?= $model->summary ?></p> -->
                        ...
                        <div class="col-12">
                            ...
                            <ul class="social list-unstyled">
                                <li>
                                    ...
                                    <div class="fb-share-button" data-href="http://abc.com/<?= Yii::$app->request->url  ?>" data-layout="button" data-size="small"><a rel="nofollow" target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fdevelopers.facebook.com%2Fdocs%2Fplugins%2F&amp;src=sdkpreparse" class="fb-xfbml-parse-ignore">Chia sẻ</a></div>
